...
| Boss Combat Framework | 빠르게 움직이는 보스 공격의 피격 누락과 복합 스킬 수명주기 관리 | 프레임 간 SphereCast, 세그먼트 사이 Capsule Overlap, 공격당 1회 타격 집합, 다단계 스킬 실행·취소·정리, Pool 재사용 시 촉수 상태 초기화 | [`BossSweepDamager.cs`](Samples/BossCombatFramework/Source/HitDetection/BossSweepDamager.cs), [`TenTacleChild.cs`](Samples/BossCombatFramework/Source/Tentacle/TenTacleChild.cs) |
